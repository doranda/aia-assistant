...
export function ConversationSidebar({ conversations, activeId, onSelect, onNew, onDelete }: ConversationSidebarProps) {
  ...
  return (
    <div className="hidden lg:block w-[260px] flex-shrink-0 border-r border-white/[0.03] bg-gradient-to-b from-white/[0.02] to-white/[0.005] shadow-[1px_0_20px_rgba(0,0,0,0.3)] overflow-y-auto">
      <div className="p-4">
      ...
      <div className="px-4">
        <div className="text-[10px] font-bold uppercase tracking-[0.12em] text-gray-8 mb-3">Conversations</div>
        ...
        {conversations.map((conv) => (
          ...
          >
            {confirmId === conv.id ? (
              <>
                <div className="text-[13px] font-medium text-red-400 truncate pr-16">Delete this chat?</div>
